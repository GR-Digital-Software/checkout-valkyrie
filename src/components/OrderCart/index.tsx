...
const OrderCart: React.FC<OrderCartProps> = ({ isOpen, setIsOpen }) => {
    return (
            ...
            <DrawerContent>
                ...
                <DrawerHeader className='flex flex-col justify-start w-full border-b-2 border-dashed border-zinc-300'>
                    <DrawerTitle className=''>
                        <div className='flex flex-col'>
                            ...
                            <p className='flex flex-row text-sm font-medium justify-center items-end text-zinc-950'>Você tem <CountdownTimer /> para finalizar seu pedido</p>
                        </div>
                    </DrawerTitle>
                </DrawerHeader>
                ...
                <DrawerFooter className='flex flex-col gap-4'>
                    <div className='flex justify-between items-end gap-2 h-10'>
                        ...
                        <Button icon={<Check size={18} />} variant='default' className='w-10 h-full' />
                    </div>
                    <Divider />
